...
class SubmitRecord(SmartOJSQLModel, table=True):
    ...
    max_memory_consumed: Decimal = Field(0, nullable=False, decimal_places=2, max_digits=8)
...
class JudgeRecord(SmartOJSQLModel, table=True):
    ...
    memory_consumed: Decimal = Field(nullable=False, decimal_places=2, max_digits=8)
